...
- [ ] Implement fingerprint migration utilities (code, not just docs): detect version, migrate records, golden vectors. (UNCHECKED by maintainer 2026-07-18: no migration code exists on main — claimed is not merged)
