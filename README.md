...
- Rollback process: `rollbackToSource()` and `rollbackBatch()` verify integrity, provenance, and source authenticity before reverting Lunum-Sem records to original natural-language text.
